...
void ObjectSpawner::spawnRandomBridge()
{
  ...
  bridge_marker.id = 11;  // Any number between 10~20
  ...
  bridge_marker.pose.position.x = bridge_position_ + 0.8;
  bridge_marker.pose.position.y = 7;
  bridge_marker.pose.position.z = 3;
  bridge_marker.pose.orientation.x = 0.0;
